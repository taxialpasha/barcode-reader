// متغيرات التطبيق
  ...
  function startScannerWithDeviceId(deviceId) {
      ...
      const targetElement = document.querySelector('#barcode-scanner-region video');
      if (!targetElement) {
  ...
  function startScanner() {
      ...
      // تحديد قارئات الرموز المتوافقة (استبعاد قارئ QR الذي يسبب الخطأ)
      const compatibleReaders = ["code_128_reader", "ean_reader", "ean_8_reader", "code_39_reader", "code_93_reader", "i2of5_reader", "2of5_reader", "codabar_reader"];
      ...
      const config = {
          inputStream: {
              ...
              constraints: {
                  ...
                  facingMode: isMobile ? "environment" : "user" // استخدام الكاميرا الأمامية للكمبيوتر المكتبي
              },
          ...
          decoder: {
              readers: compatibleReaders,
              multiple: false, // نتجاهل المتعدد للحصول على أداء أفضل
              debug: {
                  drawBoundingBox: true,
                  showFrequency: true,
                  drawScanline: true,
